<?php 
        $title = 'Airline_reservation Airlines | Change Password';
...
<?php
	...
	if(empty($_POST)===false && empty($errors)===true) {
		...
		header('Location: http://localhost/Airline_reservation/changepass.php?success');
	}
...
<?php 
      ...
      include $_SERVER["DOCUMENT_ROOT"].'/Airline_reservation/includes/overall/footer.php';
?>