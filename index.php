        ...
        <div class="col-lg-8">
          <div class="well bs-component">
            ...
            echo '<legend>Flights from '.$from.' to '.$to.'</legend>';
              ...
              <img src='/Airline_reservation/vendor/img/logo.jpg' width="100%">
              <h3>Services offered by SPD Airlines</h3>
              ...
              <h5>Book hotels via Airline_reservation Airlines and avail 10% discount per room</h5>
              <h5>Discounted travel coupons for every city</h5>
              <h5>Hire cabs or bus via Airline_reservation Airlines and avail 10% discount per ticket</h5>
